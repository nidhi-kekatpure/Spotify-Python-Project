...
##PYTHON PROJECT ON SPOTIFY DATASET BY Nidhi##
...
df_tracks = pd.read_csv('/Users/nidhikekatpure/Documents/tracks.csv')
df_tracks
...
df_genre = pd.read_csv('/Users/nidhikekatpure/Downloads/SpotifyFeatures.csv')
